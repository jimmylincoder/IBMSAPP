package com.suntek.ibmsapp.widget.media;
...
import com.suntek.ibmsapp.widget.media.callback.DanmukuSwitchListener;
import com.suntek.ibmsapp.widget.media.callback.MediaPlayerListener;
import com.suntek.ibmsapp.widget.media.callback.VideoBackListener;
...
public class MediaController extends FrameLayout
{
    ...
    private void initControllerView(View v) {
        ...
        mDanmakuLayout.setOnClickListener(v1 -> {
            if (mDanmakuShow) {
                mDanmakuImage.setImageResource(R.mipmap.bili_player_danmaku_is_open);
                mDanmakuText.setText("弹幕开");
                mDanmukuSwitchListener.setDanmakuShow(true);
                mDanmakuShow = false;
            } else {
                mDanmakuImage.setImageResource(R.mipmap.bili_player_danmaku_is_closed);
